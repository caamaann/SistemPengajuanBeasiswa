...
<div class="card" style="margin: 3%;">
    <div class="card-body">
        <h5 class="card-title">Create Ketua Program Studi</h5>
        <hr>
        <br>
        <form method="POST" action="{{ route('admin.ketua_program_studi.store') }}">
            @csrf            
            <div class="form-group row">
                <label class="col-md-3 col-form-label text-md-right">{{ __('Nama Ketua Program Studi') }}</label>
                <div class="col-md-6">
